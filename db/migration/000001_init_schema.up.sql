...
COMMENT ON COLUMN "entries"."amount" IS 'must be poitisve';

COMMENT ON COLUMN "transfers"."amount" IS 'must be poitisve';

ALTER TABLE "entries"
ADD FOREIGN KEY ("account_id") REFERENCES "accounts" ("id");

ALTER TABLE "transfers"
ADD FOREIGN KEY ("form_account_id") REFERENCES "accounts" ("id");
